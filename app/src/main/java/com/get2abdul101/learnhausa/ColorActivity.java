...
public class ColorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word ("Red", "Ja", R.drawable.color_red, R.raw.red));
        words.add(new Word ("Green", "Kore", R.drawable.color_green,R.raw.green));
        words.add(new Word ("Blue", "Shudi", R.drawable.color_white,R.raw.blue));
        words.add(new Word ("Yellow", "Ruwan dorowa", R.drawable.color_mustard_yellow,R.raw.yellow));
        words.add(new Word ("Gray", "Ruman toka", R.drawable.color_gray,R.raw.gray));
        words.add(new Word ("Black", "Baki", R.drawable.color_black,R.raw.black));
        words.add(new Word ("White", "Fari", R.drawable.color_white,R.raw.white));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    mMediaPlayer = MediaPlayer.create(ColorActivity.this, words.get(position).getmAudioResourceId() );
                    mMediaPlayer.start();
